...
// Aligned scalable tiling - static tile sizes aligned to scalable
...
// ============================================================================
// Producer fusion - unpack with scalable inner tiles fused as a
...
// Test 6 (negative): Consumer fusion - linalg.unpack with scalable inner tiles
// where the loop step (4*vscale) does NOT match the unpack inner tile size
// (8*vscale). Fusion should fail.
